...
from sl import derive_questions_from_materials
...
def main():
    ...
    if (
        ...
        with st.spinner("Summarizing and creating questions..."):
            summary, questions = derive_questions_from_materials(documents, st.session_state.language)
